...
const {login, signup, getProjectInfo, empCreate, getAllEmp, maxEmpId} = require('./controller')
...
router.get('/employee', tokenVerify, getAllEmp)
router.get('/maxempid', tokenVerify, maxEmpId)
